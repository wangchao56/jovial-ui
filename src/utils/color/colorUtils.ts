...
import * as CIELAB from './transformCIELAB'
import * as sRGB from './transformSRGB'
 ...
 * isCssColor('hsl(0,0%,100%)') // true
 * isCssColor('rgba(255,255,255,0.5)') // true
 * isCssColor('hsla(0,0%,100%,0.5)') // true
 * isCssColor('hsv(0,0%,100%)') // true
 */
