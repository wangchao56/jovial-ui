...
export * from './icons'
export const _internalIcons = {
  $close: internalIcons.MdiClose, // 关闭
  $closeCircle: internalIcons.MdiCloseCircle, // 关闭圆形
  $closeCircleOutline: internalIcons.MdiCloseCircleOutline,
  ...
  $chevronUp: internalIcons.MdiChevronUp, // 上箭头
  ...
  $check: internalIcons.MdiCheck, // 勾选
  $plus: internalIcons.MdiPlus, // 加号
  $minus: internalIcons.MdiMinus, // 减号
