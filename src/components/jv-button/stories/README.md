...
<template>
  ...
  <JvButton color-type="success">成功按钮</JvButton>
  <JvButton color-type="warning">警告按钮</JvButton>
  <JvButton color-type="error">错误按钮</JvButton>
  <JvButton color-type="info">信息按钮</JvButton>
</template>
```
...
```vue
<template>
  <JvButton block color-type="primary">块级按钮</JvButton>
</template>
```
...
<template>
  <form @submit.prevent="onSubmit">
    <!-- 表单内容 -->
    <JvButton native-type="submit" color-type="primary">提交表单</JvButton>
